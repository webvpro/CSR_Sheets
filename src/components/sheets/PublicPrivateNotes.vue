...
<template>
  ...
  >
    <div class="card-body">
      <div class="card-tile tabs">
        <a
          class="tab tab-lifted"
          :class="[activeTab === 'Notes' ? 'tab-active' : '']"
          @click.prevent="selectTab('Notes')"
          >Notes</a
        >
        <a
          class="tab tab-lifted"
          :class="[activeTab === 'Private' ? 'tab-active' : '']"
          @click.prevent="selectTab('Private')"
          >Private</a
        >
      </div>
      <textarea
